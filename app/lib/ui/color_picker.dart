...
Future<String?> showOnoteColorPicker(
  BuildContext context,
  AppState app, {
  String? initial,
  String title = 'Text colour',
  ValueChanged<String>? onChanged,
  ValueChanged<String>? onAddToToolbar,
}) {
...
class _ColorPickerDialog extends StatefulWidget {
  ...
  final ValueChanged<String>? onAddToToolbar;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextButton.icon(
                icon: Icon(
                  _customOpen ? Icons.expand_less : Icons.expand_more,
                  size: 16,
                ),
                  ...
                  child: LayoutBuilder(
                    builder: (ctx2, cons) {
                      return GestureDetector(
                        ...
                        onPanUpdate: (d) =>
                            _svAt(d.localPosition, cons.biggest),
                        child: CustomPaint(
                          size: cons.biggest,
